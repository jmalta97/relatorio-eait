...
# Calcular média do Grupo A em MPa
media_A_MPa <- mean(corposdeprova$Resistencia_kPa[corposdeprova$Grupo == "A"]) / 1000

# Formatar com 2 casas decimais
media_A_MPa_formatada <- round(media_A_MPa, 2)

# Calcular mediana do Grupo A em MPa
median_A_MPa <- median(corposdeprova$Resistencia_kPa[corposdeprova$Grupo == "A"]) / 1000

# Formatar com 2 casas decimais
median_A_MPa_formatada <- round(median_A_MPa, 2)
```
O grupo A apresentou resistência média de `r media_A_MPa_formatada` MPa e mediana de `r median_A_MPa_formatada` MPa. A proximidade entre essas duas medidas é um primeiro indício de que a distribuição é equilibrada e não está sendo fortemente afetada por valores extremos.
